...
################################
from processor.ip_to_as import DATABASE_HOST, DATABASE_SCHEMA, DATABASE_PASS, DATABASE_USER


def conectardb(db_host=DATABASE_HOST, user=DATABASE_USER, password=DATABASE_PASS, schema=DATABASE_SCHEMA):
    conndb = mdb.connect(host=db_host, user=user, passwd=password, db=schema)
